...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2023. Okt 17. 09:06
...
CREATE TABLE `altalanos_iskola` (
  ...
  `altalanos_iskolca_cime` varchar(255) CHARACTER SET utf8 COLLATE utf8_hungarian_ci NOT NULL
...
CREATE TABLE `kozepiskola` (
  ...
  `kozepiskola_neve` varchar(255) COLLATE utf8mb4_hungarian_ci NOT NULL,
  `kozepiskola_cime` varchar(255) COLLATE utf8mb4_hungarian_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hungarian_ci;
...
CREATE TABLE `tanulo` (
  ...
  `id_alt_isk` tinyint(4) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hungarian_ci;
