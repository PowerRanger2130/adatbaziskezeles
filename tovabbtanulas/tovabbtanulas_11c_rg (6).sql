...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2023. Okt 24. 08:33
...
ALTER TABLE `jelentkezes`
  ...
  ADD KEY `id_jelentkezes` (`id_jelentkezes`),
...
--
ALTER TABLE `jelentkezes`
  ADD CONSTRAINT `jelentkezes_ibfk_1` FOREIGN KEY (`tanulo_id`) REFERENCES `tanulo` (`id_tanulo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `jelentkezes_ibfk_2` FOREIGN KEY (`kozepiskola_id`) REFERENCES `kozepiskola` (`id_kozepiskola`) ON DELETE NO ACTION ON UPDATE NO ACTION;
